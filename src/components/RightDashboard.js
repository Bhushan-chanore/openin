...
const HomeFeatures = () => {
        ...
        return (
            <>
                <div className={`d-flex flex-column ${styles.w100}`}>
                    <div className={`d-flex flex-row ${styles.w1000}`}>
                        {/* <div className={`d-flex ${styles.w60} justify-content-start`}> */}
    ...
    const Schedule = () => {
        ...
        const data01 = [
            ...
            [
                { name: "Basic Tees", value: 650, fill: "#98D89E" },
                { name: "Custom Short Pants", value: 360, fill: "#F6DC7D" },
                { name: "Super Hoodies", value: 250, fill: "#EE8484" },
            ],
            [
